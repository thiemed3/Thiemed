...
def migrate(cr, installed_version):
    ...
    cr.execute("UPDATE res_partner SET city_id=c.id FROM res_city c WHERE res_partner.city_id_temp=c.code")

    cr.execute("ALTER TABLE res_partner DROP COLUMN city_id_temp")
    cr.execute(
